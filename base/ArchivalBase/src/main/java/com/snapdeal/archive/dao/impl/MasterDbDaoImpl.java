...
public class MasterDbDaoImpl implements MasterDbDao {
    ...
    public void markRelatedResultToArchive(RelationTable rt,Boolean mark) {
        ...
        if(mark){
            if(QueryType.IN.equals(rt.getQueryType())){
                String auditFieldClause = getAuditFieldClause(rt, false);
                ...
                String auditFieldClause = getAuditFieldClause(rt, true);
    ...
    private String getAuditFieldClause(RelationTable rt, Boolean isJoinQuery) {
        ...
        for(String auditField : auditFields){
            if(isJoinQuery){
                auditFieldBuilder.append("t1.");
            }
            auditFieldBuilder.append(auditField).append("=");
            if(isJoinQuery){
                auditFieldBuilder.append("t1.");
            }
            auditFieldBuilder.append(auditField);
            auditFieldBuilder.append(" , ");
        }
