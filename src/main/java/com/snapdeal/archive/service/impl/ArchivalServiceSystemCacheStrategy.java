 ...
 * @author vishesh
 */
@Service("archivalServiceSystemCacheStrategy")
public class ArchivalServiceSystemCacheStrategy extends ArchivalServiceImpl {
    ...
    public void archieveMasterData(String tableName, String baseCriteria, Long batchSize) throws BusinessException {
        ...
        // get all the base result at once
        List<Map<String, Object>> masterResult = masterDbDao.getResult(rt, baseCriteria);
   ...
   //     String criteria = baseCriteria + " limit " + start + "," + batchSize;
    ...
    private List<Map<String, Object>> getResultSet(List<Map<String, Object>> masterResult, long start, Long batchSize) {
